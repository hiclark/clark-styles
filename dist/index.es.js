...
var MAX_WIDTH = css(_templateObject);

var _templateObject$1 = taggedTemplateLiteral(['\n  padding: 0 ', ';\n  ', ';\n  margin: ', ';\n'], ['\n  padding: 0 ', ';\n  ', ';\n  margin: ', ';\n']);

var Grid = styled.div(_templateObject$1, SPACING_EXTRA_LARGE, MAX_WIDTH, function (_ref) {
...
var Row = function Row(_ref) {
  ...
  return React.createElement(
    ...
    Children.map(children, function (c, i) {
...
var RowStyle = styled.div(_templateObject$2, GUTTER_SPACING, function (_ref2) {
...
var media = Object.keys(sizes).reduce(function (acc, label) {
  acc[label] = function () {
    return css(_templateObject$3, sizes[label] / 16, css.apply(undefined, arguments));
  };
...
var Col = styled.div(_templateObject$4, function (_ref) {
  var sm = _ref.sm;
